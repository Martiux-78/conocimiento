...
|-----------------|--------------|
| - Sintaxis simple y extensible<br>- Amplio soporte de herramientas<br>- Validación estructural mediante esquemas<br>- Interoperabilidad entre sistemas | - No define semántica, solo estructura<br>- Redundancia sintáctica<br>- No permite razonamiento lógico<br>- Dificultad para expresar relaciones complejas |
